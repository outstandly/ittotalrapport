...
if menu == "Digital Marknadsföring":
    ...
    competitor_data = {
        ...
        'Digital_Annonsering': [85, 92, 88, 95, 90],  # % av marknadsföringsbudget
        'Sökords_Position': [3.2, 2.8, 3.5, 2.5, 2.1],  # Genomsnittlig position
        'Annonsinvestering': [50000, 75000, 65000, 85000, 80000],  # SEK/månad
        'Digital_Leads': [180, 250, 220, 280, 260]  # Leads per månad
    }
...
# SEO Analys
    ...
    seo_activity_data = {
        'Företag': ['IT-Total', 'Iver', 'Advania', 'Dustin', 'Atea'],
        'Innehållsuppdateringar/mån': [4, 12, 8, 15, 10],
        'Tekniska optimeringar/kvartal': [2, 6, 5, 8, 7],
        'Nya sidor/mån': [3, 8, 6, 12, 9],
        'Backlink-tillväxt/mån': [9, 25, 18, 30, 22]
    }
    ...
    maturity_data = {
        'Företag': ['IT-Total', 'Iver', 'Advania', 'Dustin', 'Atea'],
        'Innehållsstrategi': [2, 4, 3, 5, 4],  # Skala 1-5
        'Teknisk SEO': [3, 4, 4, 5, 4],
        'Länkprofil': [2, 4, 3, 4, 5],
        'Innehållskvalitet': [4, 4, 4, 5, 4]
    }
    ...
    eeat_data = {
        'Företag': ['IT-Total', 'Iver', 'Advania', 'Dustin', 'Atea'],
        'Expertis': [75, 85, 82, 80, 88],
        'Auktoritet': [70, 85, 80, 82, 86],
        'Trovärdighet': [78, 82, 80, 85, 84],
        'Erfarenhet': [72, 80, 78, 82, 85]
    }
...
# Konkurrensanalys
    ...
    traffic_data = {
        'Företag': ['IT-Total', 'Iver', 'Advania', 'Dustin', 'Atea'],
        'Organisk_Sök': [35, 55, 52, 48, 50],  # IT-Total lägre än konkurrenter
        'Direkt': [30, 15, 18, 20, 17],        # IT-Total högre i direkt trafik
        'Betald_Sök': [8, 15, 14, 18, 16],     # IT-Total betydligt lägre
        'Social': [5, 8, 9, 7, 10],            # IT-Total lägre
        'Referral': [20, 4, 5, 5, 5],          # IT-Total högre i referral
        'Email': [2, 3, 2, 2, 2]               # Liknande nivåer
    }
